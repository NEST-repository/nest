...
# TODO: changes for nest, added the import of function
from megatron.core.utils import make_viewless_tensor
torch.fx.wrap("make_viewless_tensor")
...
class SwitchMLP(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method):
        ...
        for i in range(args.num_experts):
            self.experts.append(ParallelMLP(
                init_method, output_layer_init_method))
...
# TODO: For nest, adding the following class
...
# TODO: For nest, adding the torch.fx wrap function
...
class CoreAttention(MegatronModule):
    ...
    def __init__(self, layer_number,
        ...
        # TODO: change for nest, adding the empty for fx function
        self.empty = EmptyForFx()
    ...
    def forward(self, query_layer, key_layer,
        ...
        # TODO: change for nest, creating a dummy torch.fx.wrap function around
        # matmul_input_buffer = mpu.get_global_memory_buffer().get_tensor(
        matmul_input_buffer = get_tensor_for_fx(
        ...
        # TODO: change for nest; changing the view to accept the layer shape manually
        context_layer = context_layer.view(
            new_context_layer_shape[0], new_context_layer_shape[1], new_context_layer_shape[2])
...
class ParallelAttention(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if self.attention_type == AttnType.self_attn:
            ...
            # TODO: change for nest, unrolling the new_tensor_shape instead of *new_tensor_shape
            mixed_x_layer = mixed_x_layer.view(
                new_tensor_shape[0], new_tensor_shape[1], new_tensor_shape[2], new_tensor_shape[3])
...
# TODO: change for nest, commented the decorator for tracing
# @torch.jit.script
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if self.drop_path is None:
            ...
            with self.bias_dropout_add_exec_handler():
                # TODO: change for nest, bias_dropout_add_func passes through control flow
        ...
        if self.drop_path is None:
            ...
            # 'view' tensor.
            # TODO:change for nest; function is directly used as it is wrapped in torch.fx instead of core.utils.make_viewless_tensor
...
class ParallelTransformer(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method,
        ...
        self.drop_path_rates = [rate.item() for rate in torch.linspace(
            0, self.drop_path_rate, args.num_layers)]
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        # TODO: nest change; directly invoking the make viewless tensor instead from core.utils.make_viewless_tensor
