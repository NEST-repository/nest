...
# TODO: changes made for Nest; created the class for torch.fx
...
# TODO: change made for Nest; passed the arange_fnc


def t5_position_ids(token_ids, arange_fnc):
    # Create position ids
    seq_length = token_ids.size(1)
    # TODO: change made for Nest; change from torch.arange to arange_fnc
    position_ids = arange_fnc(seq_length).to(dtype=torch.long,
...
class T5Model(MegatronModule):
    ...
    def __init__(self,
        ...
        # TODO: added the self.arange object
    ...
    def forward(self, encoder_input_ids, decoder_input_ids, encoder_attn_mask,
        ...
        # TODO: changes made for Nest; added the self.arange for both encoder and decoder
        encoder_position_ids = t5_position_ids(encoder_input_ids, self.arange)
        decoder_position_ids = t5_position_ids(decoder_input_ids, self.arange)
