from Estimator import nest_coretype_mapping, tc_configs, vc_configs
from Estimator import create_core_config, get_flops
from Estimator import convert_nest_to_fused_graph, get_engine_type
...
def extract_op_graph_ilp(per_l_op_graph, cc, latency_estimates):
    ...
    def generate_digraph_from_fused_graph(wgraph, mode="fwd"):
        ...
        for node in wgraph.nodes.values():
            ...
            node_attr["core_type"] = nest_coretype_mapping[get_engine_type(
                node.node_desc)]
    ...
    w_fwd_graph = convert_nest_to_fused_graph(per_l_op_graph, "fwd")
    w_bwd_graph = convert_nest_to_fused_graph(per_l_op_graph, "bwd")
