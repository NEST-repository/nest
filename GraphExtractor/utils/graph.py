...
class NestGraph:
    ...
    def __init__(self, tmp_width, model_name, ep_degree) -> None:
    ...
    def print_graph(self, out_dir, micro_batch_size=1, sequence_length=1):
        ...
        out_file_dot = str(out_dir) + generate_out_filename(self.model_name,
                                                            "dot", micro_batch_size, self.tmp_width, sequence_length, ep_degree=self.ep_degree)
        out_file_png = str(out_dir) + generate_out_filename(self.model_name,
                                                            "png", micro_batch_size, self.tmp_width, sequence_length,ep_degree=self.ep_degree)
    ...
    def setup_node_and_edges(self, graphmodule, node, layer_id):
        ...
        # create nest node in the graph
        node_attributes = NestNode(node, idx_node, layer_id, inputs)
